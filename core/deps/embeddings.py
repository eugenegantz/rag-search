...
if MODEL_LOCAL_PATH.exists() and any(MODEL_LOCAL_PATH.iterdir()):
    ...
    model       = AutoModel.from_pretrained(str(MODEL_LOCAL_PATH), local_files_only=True)       # type: ignore
    tokenizer   = AutoTokenizer.from_pretrained(str(MODEL_LOCAL_PATH), local_files_only=True)   # type: ignore
    ...
    model       = AutoModel.from_pretrained(DEFAULT_MODEL_NAME)         # type: ignore
    tokenizer   = AutoTokenizer.from_pretrained(DEFAULT_MODEL_NAME)     # type: ignore
